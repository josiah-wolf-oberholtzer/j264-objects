...
,
		"rect" : [ 297.0, 472.0, 1109.0, 476.0 ],
		"bglocked" : 0,
		"defrect" : [ 297.0, 472.0, 1109.0, 476.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 630.0, 230.0, 450.0, 210.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 470.0, 230.0, 150.0, 210.0 ],
...
, 			{
				"box" : 				{
					...
					"id" : "obj-13",
					"maxclass" : "bpatcher",
					"name" : "j264.mod.harmonizer~.maxpat",
					"numinlets" : 9,
					"numoutlets" : 9,
					"outlettype" : [ "", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal" ],
