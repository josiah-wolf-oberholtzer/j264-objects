...
,
		"rect" : [ 287.0, 201.0, 1020.0, 530.0 ],
		"bgcolor" : [ 1.0, 1.0, 1.0, 0.0 ],
		"bglocked" : 0,
		"defrect" : [ 287.0, 201.0, 1020.0, 530.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "j264.moddsp.algwrapper~ #0 1x1 j264.mod.gizmo~.alg.voix.maxpat"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 70.0, 265.0, 349.0, 20.0 ],
					"text" : "j264.tabs main pitch transp sends12 sends34 sends56 sends78"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 70.0, 405.0, 84.0, 20.0 ],
					"text" : "output meters"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 175.0, 450.0, 12.0, 60.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 160.0, 450.0, 12.0, 60.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 145.0, 450.0, 12.0, 60.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 130.0, 450.0, 12.0, 60.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 115.0, 450.0, 12.0, 60.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 100.0, 450.0, 12.0, 60.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 85.0, 450.0, 12.0, 60.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 70.0, 450.0, 12.0, 60.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 9,
					"outlettype" : [ "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 70.0, 425.0, 123.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 70.0, 370.0, 57.0, 18.0 ],
					"text" : "/page $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"patching_rect" : [ 70.0, 295.0, 60.0, 65.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 380.0, 30.0, 60.0, 170.0 ],
					"tabs" : [ "main", "pitch", "transp", "sends12", "sends34", "sends56", "sends78" ]
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-35",
					"maxclass" : "bpatcher",
					"name" : "j264.mod.gizmo~.parambp.maxpat",
					"numinlets" : 9,
					"numoutlets" : 0,
					"patching_rect" : [ 150.0, 330.0, 125.0, 45.0 ],
					"presentation" : 1,
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-35", 0 ],
					"hidden" : 0,
					"midpoints" : [ 549.5, 325.0, 159.5, 325.0 ],
					"source" : [ "obj-16", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-35", 8 ],
					"hidden" : 0,
					"midpoints" : [ 79.5, 395.0, 138.0, 395.0, 138.0, 320.0, 265.5, 320.0 ],
					"source" : [ "obj-45", 0 ]
				}
