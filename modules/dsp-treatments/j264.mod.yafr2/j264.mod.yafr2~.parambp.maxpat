...
, 			{
				"box" : 				{
					"args" : [ "diffusion", 8, "@range/bounds", 0.0, 1 ],
					"id" : "obj-44",
					"maxclass" : "bpatcher",
...
, 			{
				"box" : 				{
					"args" : [ "damping", 8, "@range/bounds", 0.0, 1 ],
					"id" : "obj-42",
					"maxclass" : "bpatcher",
					"name" : "j264.bp.paramwrapper.Nx.maxpat",
					"numinlets" : 2,
