...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 175.0, 580.0, 91.0, 20.0 ],
					"text" : "vexpr $f1 * 512"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 155.0, 540.0, 38.5, 20.0 ],
					"text" : "t b l"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 155.0, 630.0, 225.0, 20.0 ],
					"text" : "jit.matrix #0-delay-matrix 1 float32 256"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 175.0, 605.0, 141.0, 20.0 ],
					"text" : "jit.fill #0-delay-matrix 0"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 155.0, 655.0, 137.0, 20.0 ],
					"text" : "jit.buffer~ #0-delay 30"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "j264.moddsp.algwrapper~ #0 1x1 j264.mod.specdelay~.alg.voix.maxpat"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 40.0, 95.0, 162.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 75.0, 295.0, 315.0, 20.0 ],
					"text" : "j264.tabs main delay sends12 sends34 sends56 sends78"
				}
...
, 			{
				"box" : 				{
					...
					"tabs" : [ "main", "delay", "sends12", "sends34", "sends56", "sends78" ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 9,
					"outlettype" : [ "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 155.0, 325.0, 124.0, 20.0 ],
					"text" : "j264.io9 #0-output"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-35", 8 ],
					"hidden" : 0,
					"midpoints" : [ 84.5, 425.0, 143.0, 425.0, 143.0, 350.0, 269.5, 350.0 ],
					"source" : [ "obj-45", 0 ]
				}
