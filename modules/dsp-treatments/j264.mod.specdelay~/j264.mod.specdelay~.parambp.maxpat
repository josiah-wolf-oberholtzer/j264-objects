...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 110.0, 255.0, 83.0, 20.0 ],
					"text" : "r #0-control"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 265.0, 120.0, 85.0, 20.0 ],
					"text" : "s #0-control"
				}
...
, 			{
				"box" : 				{
					"args" : [ "DELAY", 256, "@rect", 280.0, 75.0 ],
					"id" : "obj-16",
					"maxclass" : "bpatcher",
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 110.0, 470.0, 135.0, 75.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 15.0, 280.0, 75.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 150.0, 155.0, 135.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 150.0, 135.0, 135.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 150.0, 115.0, 135.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 150.0, 95.0, 135.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 970.0, 290.0, 180.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1380.0, 370.0, 135.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 155.0, 135.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1380.0, 370.0, 135.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 135.0, 135.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1380.0, 370.0, 135.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 115.0, 135.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1255.0, 370.0, 135.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 95.0, 135.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					"args" : [ "delay", 256, "@range/bounds", 0.0, 1.0 ],
					"id" : "obj-2",
					"maxclass" : "bpatcher",
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 110.0, 285.0, 290.0, 175.0 ],
					"presentation" : 1,
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 1 ],
					"hidden" : 0,
					"midpoints" : [ 235.5, 550.0, 412.0, 550.0, 412.0, 278.0, 390.5, 278.0 ],
					"source" : [ "obj-16", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"hidden" : 0,
					"midpoints" : [ 119.5, 550.0, 104.0, 550.0, 104.0, 280.0, 119.5, 280.0 ],
					"source" : [ "obj-16", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 390.5, 465.0, 235.5, 465.0 ],
					"source" : [ "obj-2", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 1745.5, 365.0, 1389.5, 365.0 ],
					"source" : [ "obj-48", 1 ]
				}
