...
,
		"rect" : [ 10.0, 230.0, 450.0, 210.0 ],
		"bgcolor" : [ 1.0, 1.0, 1.0, 0.0 ],
		"bglocked" : 0,
		"defrect" : [ -735.0, 318.0, 629.0, 518.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"text" : "j264.moddsp.algwrapper~ #0 1x1 j264.mod.vocoder~.alg.voix.maxpat",
					"varname" : "j264.moddsp.algwrapper~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "int" ],
					"patching_rect" : [ 525.0, 75.0, 43.0, 16.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 40.0, 95.0, 514.0, 20.0 ],
					"text" : "j264.common.module #0 @automate threshold pulseperiod pulsewidth pulseamplitude filterq"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 75.0, 295.0, 355.0, 34.0 ],
					"text" : "j264.tabs main threshold pulseperiod pulsewidth pulseamplitude filterq sends12 sends34 sends56 sends78"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 290.0, 375.0, 84.0, 20.0 ],
					"text" : "output meters"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 430.0, 375.0, 77.0, 20.0 ],
					"text" : "input meters"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 395.0, 420.0, 12.0, 60.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 380.0, 420.0, 12.0, 60.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 365.0, 420.0, 12.0, 60.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 350.0, 420.0, 12.0, 60.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 335.0, 420.0, 12.0, 60.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 320.0, 420.0, 12.0, 60.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 305.0, 420.0, 12.0, 60.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 290.0, 420.0, 12.0, 60.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 9,
					"outlettype" : [ "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 290.0, 395.0, 123.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 75.0, 415.0, 57.0, 18.0 ],
					"text" : "/page $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"patching_rect" : [ 75.0, 340.0, 60.0, 65.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 380.0, 30.0, 60.0, 170.0 ],
					"tabs" : [ "main", "threshold", "pulseperiod", "pulsewidth", "pulseamplitude", "filterq", "sends12", "sends34", "sends56", "sends78" ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 535.0, 420.0, 12.0, 60.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 520.0, 420.0, 12.0, 60.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 505.0, 420.0, 12.0, 60.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 490.0, 420.0, 12.0, 60.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 475.0, 420.0, 12.0, 60.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 460.0, 420.0, 12.0, 60.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 445.0, 420.0, 12.0, 60.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 430.0, 420.0, 12.0, 60.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 9,
					"outlettype" : [ "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 430.0, 395.0, 139.5, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 9,
					"outlettype" : [ "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 155.0, 340.0, 125.0, 20.0 ],
					"text" : "j264.io9 #0-output"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-35",
					"maxclass" : "bpatcher",
					"name" : "j264.mod.vocoder~.parambp.maxpat",
					"numinlets" : 9,
					"numoutlets" : 0,
					"patching_rect" : [ 155.0, 375.0, 125.0, 45.0 ],
					"presentation" : 1,
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-35", 0 ],
					"hidden" : 0,
					"midpoints" : [ 554.5, 368.0, 164.5, 368.0 ],
					"source" : [ "obj-13", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-35", 8 ],
					"hidden" : 0,
					"midpoints" : [ 84.5, 440.0, 143.0, 440.0, 143.0, 365.0, 270.5, 365.0 ],
					"source" : [ "obj-45", 0 ]
				}
