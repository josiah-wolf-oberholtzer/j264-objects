...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 495.0, 230.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 515.0, 230.0, 71.0, 20.0 ],
					"text" : "route /mute"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "j264.moddsp.algwrapper~ #0 1x1 j264.mod.backforth~.alg.voix.maxpat"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 405.0, 230.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 295.0, 230.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 130.0, 230.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 75.0, 230.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 9,
					"outlettype" : [ "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 75.0, 200.0, 459.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 370.0, 260.0, 345.0, 20.0 ],
					"text" : "j264.tabs main size transp sends12 sends34 sends56 sends78"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 370.0, 365.0, 57.0, 18.0 ],
					"text" : "/page $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"patching_rect" : [ 370.0, 290.0, 60.0, 65.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 380.0, 30.0, 60.0, 170.0 ],
					"tabs" : [ "main", "size", "transp", "sends12", "sends34", "sends56", "sends78" ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 9,
					"outlettype" : [ "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 450.0, 290.0, 125.0, 20.0 ],
					"text" : "j264.io9 #0-output"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-35",
					"maxclass" : "bpatcher",
					"name" : "j264.mod.backforth~.parambp.maxpat",
					"numinlets" : 9,
					"numoutlets" : 0,
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-35", 8 ],
					"hidden" : 0,
					"midpoints" : [ 379.5, 390.0, 438.0, 390.0, 438.0, 315.0, 565.5, 315.0 ],
					"source" : [ "obj-45", 0 ]
				}
