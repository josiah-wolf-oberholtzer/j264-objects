...
,
		...
		"bglocked" : 1,
		"defrect" : [ 198.0, 44.0, 1565.0, 1130.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 60.0, 95.0, 50.0, 80.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 115.0, 95.0, 50.0, 80.0 ]
				}
...
, 			{
				"box" : 				{
					"args" : [ "scrub", 8, "@range/bounds", 0, 3000 ],
					"id" : "obj-31",
					"maxclass" : "bpatcher",
...
, 			{
				"box" : 				{
					"args" : [ "envtrans", 8, "@range/bounds", -1200, 1200 ],
					"id" : "obj-32",
					"maxclass" : "bpatcher",
					"name" : "j264.bp.paramwrapper.Nx.maxpat",
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 95.0, 50.0, 80.0 ]
				}

			}
, 			{
				"box" : 				{
					"args" : [ "TRANS", "@rect", 50, 75 ],
					"id" : "obj-21",
					"maxclass" : "bpatcher",
					"name" : "j264.ui.multislider.maxpat",
					"numinlets" : 1,
					...
					"presentation" : 1,
					"presentation_rect" : [ 115.0, 15.0, 50.0, 75.0 ]
				}

			}
, 			{
				"box" : 				{
					"args" : [ "NOISE", "@rect", 50, 75 ],
					"id" : "obj-18",
					"maxclass" : "bpatcher",
					"name" : "j264.ui.multislider.maxpat",
					"numinlets" : 1,
					...
					"presentation" : 1,
					"presentation_rect" : [ 60.0, 15.0, 50.0, 75.0 ]
				}

			}
, 			{
				"box" : 				{
					"args" : [ "SINUS", "@rect", 50, 75 ],
					"id" : "obj-16",
					"maxclass" : "bpatcher",
					"name" : "j264.ui.multislider.maxpat",
					"numinlets" : 1,
					...
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 15.0, 50.0, 75.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 170.0, 155.0, 115.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 170.0, 135.0, 115.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 170.0, 115.0, 115.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 170.0, 95.0, 115.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 170.0, 75.0, 115.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 170.0, 55.0, 115.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 170.0, 35.0, 115.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 170.0, 15.0, 115.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					"args" : [ "relax", 8, "@range/bounds", 0, 250 ],
					"id" : "obj-44",
					"maxclass" : "bpatcher",
					"name" : "j264.bp.paramwrapper.Nx.maxpat",
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					"args" : [ "transients", 8, "@range/bounds", 0.0, 1.0 ],
					"id" : "obj-42",
					"maxclass" : "bpatcher",
					"name" : "j264.bp.paramwrapper.Nx.maxpat",
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					"args" : [ "sinusoids", 8, "@range/bounds", 0, 1 ],
					"id" : "obj-2",
					"maxclass" : "bpatcher",
					"name" : "j264.bp.paramwrapper.Nx.maxpat",
					"numinlets" : 1,
