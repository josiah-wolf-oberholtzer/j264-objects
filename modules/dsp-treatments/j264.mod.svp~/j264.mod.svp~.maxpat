...
, 			{
				"box" : 				{
					...
					"text" : "j264.moddsp.algwrapper~ #0 1x1 j264.mod.svp~.alg.voix.maxpat"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 370.0, 260.0, 465.0, 20.0 ],
					"text" : "j264.tabs main sinus noise trans relax env scrub sends12 sends34 sends56 sends78"
				}
...
, 			{
				"box" : 				{
					...
					"tabs" : [ "main", "sinus", "noise", "trans", "relax", "env", "scrub", "sends12", "sends34", "sends56", "sends78" ]
				}
