...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 545.0, 180.0, 71.0, 20.0 ],
					"text" : "route /mute"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 545.0, 230.0, 44.0, 20.0 ],
					"text" : "mute~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "signal", "" ],
					"patching_rect" : [ 545.0, 205.0, 70.0, 20.0 ],
					"text" : "j264.mute~"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "j264.moddsp.algwrapper~ 26000 2x2 j264.mod.granulator~.alg.voix.maxpat"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 40.0, 90.0, 322.0, 20.0 ],
					"text" : "j264.common.module #0 @automate rate length pitch gain"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 75.0, 295.0, 450.0, 20.0 ],
					"text" : "j264.tabs main rate length pitch gain feedback sends12 sends34 sends56 sends78"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 9,
					"outlettype" : [ "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 290.0, 380.0, 125.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 75.0, 380.0, 57.0, 18.0 ],
					"text" : "/page $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 75.0, 325.0, 60.0, 50.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 380.0, 30.0, 60.0, 170.0 ],
					"tabs" : [ "main", "rate", "length", "pitch", "gain", "feedback", "sends12", "sends34", "sends56", "sends78" ]
				}
...
, 			{
				"box" : 				{
					"id" : "obj-35",
					"maxclass" : "bpatcher",
					"name" : "j264.mod.granulator~.parambp.maxpat",
					"numinlets" : 9,
					"numoutlets" : 0,
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 571.5, 227.0, 554.5, 227.0 ],
					"source" : [ "obj-13", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 19.5, 175.0, 84.5, 175.0 ],
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 19.5, 175.0, 554.5, 175.0 ],
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 84.5, 405.0, 143.0, 405.0, 143.0, 350.0, 270.5, 350.0 ],
					"source" : [ "obj-45", 0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "j264.mod.granulator~.parambp.maxpat",
				"bootpath" : "/Users/josiah/Documents/Freelance/barroso/aninwardflow/library/j264-objects/modules/dsp-treatments/j264.mod.granulator~",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				...
				"bootpath" : "/Users/josiah/Documents/Freelance/barroso/aninwardflow/library/j264-objects/bpatchers/j264.bp.paramwrapper/j264.bp.paramwrapper.range",
				"patcherrelativepath" : "../../../bpatchers/j264.bp.paramwrapper/j264.bp.paramwrapper.range",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
...
, 			{
				...
				"bootpath" : "/Users/josiah/Documents/Freelance/barroso/aninwardflow/library/j264-objects/bpatchers/j264.ui.jogslider",
...
, 			{
				"name" : "j264.polyassist~.2x2.maxpat",
				"bootpath" : "/Users/josiah/Documents/Freelance/barroso/aninwardflow/library/j264-objects/abstractions/dsp/j264.polyassist~",
				"patcherrelativepath" : "../../../abstractions/dsp/j264.polyassist~",
				"type" : "JSON",
				"implicit" : 1
...
, 			{
				"name" : "j264.poly~.2ch-allocator.maxpat",
				"bootpath" : "/Users/josiah/Documents/Freelance/barroso/aninwardflow/library/j264-objects/abstractions/dsp/j264.poly~.2ch-allocator",
				"patcherrelativepath" : "../../../abstractions/dsp/j264.poly~.2ch-allocator",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "j264.mod.granulator~.alg.voix.maxpat",
				"bootpath" : "/Users/josiah/Documents/Freelance/barroso/aninwardflow/library/j264-objects/modules/dsp-treatments/j264.mod.granulator~",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
...
, 			{
				"name" : "j264.rangetocenter.maxpat",
				"bootpath" : "/Users/josiah/Documents/Freelance/barroso/aninwardflow/library/j264-objects/abstractions/utility/j264.rangetocenter",
				"patcherrelativepath" : "../../../abstractions/utility/j264.rangetocenter",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
