...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 285.0, 75.0, 139.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 105.0, 195.0, 48.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 45.0, 70.0, 48.0, 19.0 ],
					"text" : "ACTIVE"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 25.0, 70.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 215.0, 210.0, 87.0, 19.0 ],
					"text" : "loadmess 2000"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 265.0, 245.0, 150.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 60.0, 115.0, 73.0, 19.0 ],
					"text" : "GATE DELAY"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 210.0, 240.0, 50.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 10.0, 115.0, 50.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 135.0, 280.0, 150.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 45.0, 90.0, 60.0, 19.0 ],
					"text" : "POLARITY"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 125.0, 160.0, 100.0, 19.0 ],
					"text" : "loadmess 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 115.0, 385.0, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 105.0, 90.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 105.0, 275.0, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 25.0, 90.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 135.0, 251.0, 46.0, 19.0 ],
					"text" : "jcom.in"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 130.0, 305.0, 103.0, 31.0 ],
					"text" : "j264.mod.midiin.alg"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"hidden" : 0,
					"midpoints" : [ 106.0, 352.0, 61.0, 258.0, 100.0, 245.0 ],
					"source" : [ "obj-20", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 0 ],
					"hidden" : 0,
					"midpoints" : [ 28.0, 279.0, 69.0, 172.0, 94.5, 180.0 ],
					"source" : [ "obj-20", 2 ]
				}
