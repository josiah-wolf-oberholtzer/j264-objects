...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 13.0, 11.0, 508.0, 48.0 ],
					"text" : "- filters out incoming \"done\" msgs from (inlet 1) so that they are not send to j264.discover\n- prepends the appropriate prefix tag from (inlet 2)\n- but still have \"done\" msgs coming from j264.discover that gets sent to the outlets  "
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 55.0, 220.0, 155.0, 48.0 ],
					"text" : "%s%s\nno space between module name and member name"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 312.0, 356.0, 106.0, 20.0 ],
					"text" : "prepend /discover"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 312.0, 327.0, 55.0, 20.0 ],
					"text" : "prepend"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "" ],
					"patching_rect" : [ 312.0, 388.0, 86.0, 20.0 ],
					"text" : "j264.discover"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 427.0, 81.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 312.0, 439.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 345.5, 439.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 379.0, 439.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 218.0, 248.0, 80.0, 20.0 ],
					"text" : "sprintf %s%s"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 312.0, 248.0, 35.0, 20.0 ],
					"text" : "== 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 282.0, 165.0, 49.0, 20.0 ],
					"text" : "t l l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 312.0, 290.0, 34.0, 20.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 312.0, 209.0, 99.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 244.0, 125.0, 57.0, 20.0 ],
					"text" : "zl slice 1"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 388.5, 414.0, 388.5, 414.0 ],
					"source" : [ "obj-14", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 227.5, 280.0, 336.5, 280.0 ],
					"source" : [ "obj-16", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 436.5, 319.0, 321.5, 319.0 ],
					"source" : [ "obj-30", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 291.5, 155.0, 291.5, 155.0 ],
					"source" : [ "obj-40", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 291.5, 207.0, 227.5, 207.0 ],
					"source" : [ "obj-57", 0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "\\Documents and Settings\\Anna Huang\\My Documents\\Dropbox\\j264-objects\\abstractions\\utility\\j264.discover",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
