...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 60.0, 320.0, 103.0, 20.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 60.0, 250.0, 103.0, 20.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 140.0, 180.0, 103.0, 20.0 ],
					"text" : "loadmess MONO"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 140.0, 110.0, 103.0, 20.0 ],
					"text" : "loadmess MONO"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 140.0, 40.0, 103.0, 20.0 ],
					"text" : "loadmess MONO"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 30.0, 180.0, 100.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 135.0, 2.0, 60.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 30.0, 110.0, 100.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 75.0, 2.0, 60.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "jcom.parameter iosetup/algorithm/mode @type string @repetitions/allow 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 30.0, 40.0, 100.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 15.0, 2.0, 60.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "jcom.parameter iosetup/output/limiter/bypass @type boolean @repetitions/allow 0"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "jcom.parameter iosetup/input/limiter/bypass @type boolean @repetitions/allow 0"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "jcom.parameter iosetup/input/mode @type string @repetitions/allow 0"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 69.5, 274.5, 39.5, 274.5 ],
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 69.5, 344.5, 39.5, 344.5 ],
					"source" : [ "obj-16", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 149.5, 64.5, 39.5, 64.5 ],
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 149.5, 134.5, 39.5, 134.5 ],
					"source" : [ "obj-3", 0 ]
				}
